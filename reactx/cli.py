...
def _cmd_run(args: argparse.Namespace) -> int:
    ...
    log.info(
        "description=%s placement.initial_separation=%.2f "
        "endpoint_relax.fmax=%.4f neb.n_images=%d",
        cfg.description,
        cfg.placement.initial_separation,
    ...
    log.info(
        "R-side endpoint relax: optimizer=%s fmax=%.4f max_steps=%d",
        cfg.endpoint_relax.optimizer,
        cfg.endpoint_relax.fmax,
    ...
    log.info(
        "R-side relax: converged=%s n_steps=%d final_fmax=%.4f",
        info_r["converged"],
        info_r["n_steps"],
        info_r["final_fmax"],
    )
    ...
    log.info(
        "P-side relax: converged=%s n_steps=%d final_fmax=%.4f",
        info_p["converged"],
        info_p["n_steps"],
        info_p["final_fmax"],
    )
